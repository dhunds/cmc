...
?> 
<h3 class="headingText">Cab Bookings</h3>
<div class="articleBorder">
<form action="mCabBookings.php" method="POST">
<table width="50%">
	<tr>
		<td width="100px" class="bluetext">Cab Type</td>
	...
	{	
		...
		{		
			...
			{				
				...
				echo "<div class='pure-u-3-24'><p>" . $row['CabName']. "</p></div>";	
				echo "<div class='pure-u-3-24'><p>" . $row['CabType'] . " </p></div>";
				...
				echo "<div class='pure-u-3-24'><p>" . $row['BookingRefNo'] . " </p></div>";	
				echo "</div>";
			}	
