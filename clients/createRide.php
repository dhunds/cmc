    ...
    <script>
        ...
        function showMembersJoined(cabId) {
            ...
            var top = (screen.height/2)-(450/2);
             return window.open('joinedMembers.php?cabId='+cabId, 'iShareRyde', 'toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=450, height=450, top='+top+', left='+left);
        }
    </script>
