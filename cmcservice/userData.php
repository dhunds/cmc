...
if (isset($_POST['mobileNumber']) && $_POST['mobileNumber'] != '') {
    ...
    $sql = "SELECT id, FullName, Email, referralCode, totalCredits, usedReferralCode as signedUpUsingCode, DeviceToken, status, mobikwikToken  FROM registeredusers WHERE MobileNumber='".$_POST['mobileNumber']."'";
    $stmt = $con->query($sql);
