...
function sendPaymentMailOwner ($email, $RideDetail, $subject){
    ...
    $str = '<div  style="margin:0px;">
      <table border="0" align="center" cellpadding="0" width="600" cellspacing="0" bgcolor="#f5f5f5" style="margin:0 auto;table-layout:fixed">
            ...
            <tr>
               <td>
                  <table align="center" border="0" cellpadding="0" cellspacing="0" width="600">
                     <tbody>
                        <tr>
                           <td align="center"><a href="https://www.ishareryde.com" target="_blank"><img alt="" src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/logo.png" style="display:block" border="0" /></a></td>
                        </tr>
                     </tbody>
                  </table>
               </td>
                                 ...
                                 <tr>
                                    <td>
                                       <table align="center" border="0"cellpadding="0" cellspacing="0" width="450">
                                          <tbody>
                                             <tr style="">
                                                <td align="left" style="font-size:28px; color:#16a4de; font-family: Helvetica, Arial, sans-serif;"><img src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/rupees.png" /> <span style="padding:0 0 5px 0; vertical-align:top;">'.$RideDetail['ride']['amount'].'</span></td>
                                             ...
                                             <tr >
                                                <td><img alt="" src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/space.gif" style="display:block" border="0" height="20" width="300" /></td>
                                             </tr>
                                          </tbody>
                                       </table>
                                    </td>
                                             ...
                                             <tbody>
                                                <tr>
                                                   <td width="60%" align="left" style="font-size:14px; line-height:22px; color:#8e8e8e; font-family: Helvetica, Arial, sans-serif;">
                                                      <div style="float:left; margin-right:15px;"><img src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/map.png" /></div>
                                    ...
                                    <tr >
                                       <td colspan="2"><img alt="" src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/space.gif" style="display:block" border="0" height="20" width="300" /></td>
                                    </tr>
                                 </tbody>
                              </table>
                           </td>
         ...
         <tr >
            <td><img alt="" src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/space.gif" style="display:block" border="0" height="15" width="300" /></td>
         </tr>
         <tr>
            ...
            <td>
               <table align="center" border="0"cellpadding="0" cellspacing="0" width="450">
                  <tbody>
                     ...
                     <tr >
                        <td colspan="2"><img alt="" src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/space.gif" style="display:block" border="0" height="15" width="300" /></td>
                     </tr>
                     <tr>
                        <td align="center"><a href="https://www.facebook.com/ishareryde" target="_blank"><img src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/facebook.png" /></a> <a href="https://twitter.com/ishareryde" target="_blank"><img src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/twitter.png" /></a></td>
                     </tr>
                     <tr >
                        <td colspan="2"><img alt="" src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/space.gif" style="display:block" border="0" height="15" width="300" /></td>
                     </tr>
                        ...
                        <td>
                           <table align="center" border="0"cellpadding="0" cellspacing="0" width="450">
                              <tbody>
                                 <tr>
                                    <td>
                                       <table align="center" border="0"cellpadding="0" cellspacing="0" width="450">
                                          <tbody>
                                             <tr style="">
                                                <td align="left" style="font-size:28px; color:#16a4de; font-family: Helvetica, Arial, sans-serif;"><img src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/rupees.png" /> <span style="padding:0 0 5px 0; vertical-align:top;">'.$rideDetails['amount'].'</span></td>
                                                <td align="right" style="font-size:14px; color:#8e8e8e; font-family: Helvetica, Arial, sans-serif;
                                                   Helvetica, Arial, sans-serif;">'.date('F d, Y').'</td>
                                             </tr>
                                             <tr >
                                    ...
                                    <td>
                                       <table align="center" border="0"cellpadding="0" cellspacing="0" width="450">
                                          <tbody>
                                             ...
                                             <tr >
                                                <td colspan="2"><img alt="" src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/space.gif" style="display:block" border="0" height="10" width="300" /></td>
                                             </tr>
                                             <tr>
                                          ...
                                          <tbody>
                                             <tr>
                                                <td align="left" style="font-size:14px; line-height:25px; color:#8e8e8e; font-family: Helvetica, Arial, sans-serif;">
                                                   <div style="float:left; margin-right:15px; height:125px;"><img src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/map.png" /></div>'.$rideDetails['MemberLocationAddress'].'<br/><br/>
                                 ...
                                 <tr >
                                    <td colspan="2"><img alt="" src="http://ezeiadev.cloudapp.net/ishareryde-mailer/images/space.gif" style="display:block" border="0" height="30" width="300" /></td>
                                 </tr>
                                 <tr>
                                    <td>
                                       <table align="center" border="0"cellpadding="0" cellspacing="0" width="450">
